...
function Brand() {
  return <a className="brand" href="#top" aria-label="Shivaay Dental Care home"><span className="brand-symbol"><img src={clinic.logo} alt="" /></span><span className="brand-wordmark"><strong>SHIVAAY</strong><small>DENTAL CARE <i>&amp;</i> ORTHODONTIC CENTER</small></span></a>;
}
